package co.com.mstestneoris.configuration;
...
public class SwaggerConfiguration {
	...
	@Bean
	public Docket eDesignApi(SwaggerProperties swaggerConfigProperties) {
	...
	@Bean
	UiConfiguration uiConfig(SwaggerProperties swaggerConfigProperties) {
	...
	private ApiInfo apiInfo(SwaggerProperties swaggerConfigProperties) {
